...
module.exports = {
    ...
    async autocomplete(interaction, client) {
        ...
        try {
            ...
            log('ERROR', 'AUTOCOMPLETE_KELAS', `Error: ${error.message}`);
            await interaction.respond([]);
        }
    },
    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            log('ERROR', 'KELAS_COMMAND', `Error pada /kelas ${subcommand}: ${error.message}`);
        ...
        if (deleteAll) {
            ...
            try {
                ...
                if (err.code === 'InteractionCollectorError') {
                    ...
                    log('ERROR', 'KELAS_DELETE_ALL', `Error saat konfirmasi hapus semua kelas: ${err.message}`);
                    throw err;
                }
            }
        }
